...
const Home = () => {
  ...
  useEffect(() => {
    axios
      ...
      .catch((err) => {
        console.error("Jewellery fetch error:", err);
        setLoadingJewellery(false);
      });
...
const ProductSection = ({ title, items, loading, refObj, scrollSection, type }) => {
  return (
    <div className="px-4 mt-14 " style={{ backgroundColor: '#FFF8E7' }}>
      ...
      <div className="relative">
        ...
        <div
          ref={refObj}
          className="flex overflow-x-auto gap-6 pb-4 px-10 min-h-[260px]"
        >
          {loading ? (
            <Spinner />
          ) : (
